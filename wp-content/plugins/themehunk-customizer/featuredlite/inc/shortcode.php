...
<div class="container">
 ...
 <?php if(get_theme_mod( 'prlx_opn_new_tab')==''){?>
        <a href="<?php echo get_theme_mod( 'parallax_button_link','#'); ?>"><button><?php echo get_theme_mod( 'parallax_button_text',__('Buy Now','featuredlite')); ?></button></a>
  <?php } else { ?>
        <a href="<?php echo get_theme_mod( 'parallax_button_link','#'); ?>" target=_blank><button><?php echo get_theme_mod( 'parallax_button_text',__('Buy Now','featuredlite')); ?></button></a>
      <?php } ?>    
      </div>
      <?php } ?>
    </div>
   ...
   <div class="cnt-detail">
     <ul>
      <?php if($cnt_tel!=''){?>
       ...
       <div class="cnt-info"><a href="<?php echo $cnt_tel;?>"><?php echo $cnt_tel;?></a></div>
       </li>
       <?php } ?>
       <?php if($cnt_add!=''){?>
       <li class="address">
...
<?php if($cnt_mail!=''){?>
        <li class="email-ad">
        <div class="cnt-icon"><a href="mailto:<?php echo $cnt_mail;?>"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></div>
