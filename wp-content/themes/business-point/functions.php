...
function business_point_scripts() {
	...
	wp_enqueue_script( 'business-point-custom', get_template_directory_uri() . '/assets/js/custom.js', array( 'jquery' ), '2.0.0', true );
...
function business_point_admin_scripts( $hook ) {
	...
	if( 'widgets.php' === $hook ){
		...
		wp_enqueue_style( 'business-point-admin', get_template_directory_uri() . '/includes/widgets/css/admin.css', array(), '2.0.0' );

		wp_enqueue_media();

		wp_enqueue_script( 'business-point-admin', get_template_directory_uri() . '/includes/widgets/js/admin.js', array( 'jquery' ), '2.0.0' );
