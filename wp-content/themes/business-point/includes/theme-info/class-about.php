	...
	class Business_Point_About {
		...
		public function load_assets( $hook ) {
			...
			if ( 'appearance_page_' . $this->page_slug === $hook ) {
				...
				wp_enqueue_style( 'business-point-about', get_template_directory_uri() . '/includes/theme-info/css/about.css', array(), '2.0.0' );
				wp_enqueue_script( 'business-point-about', get_template_directory_uri() . '/includes/theme-info/js/about.js', array( 'jquery' ), '2.0.0' );
				$js_vars = array(
