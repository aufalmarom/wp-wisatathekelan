...
class Hestia_Header extends Hestia_Abstract_Main {
	...
	public function init() {
		$this->loader->add_action( 'hestia_do_header', $this, 'the_header_content' );
		$this->loader->add_action( 'hestia_do_header', $this, 'hidden_sidebars' );
		$this->loader->add_action( 'wp_enqueue_scripts', $this, 'top_bar_style' );
		$this->loader->add_filter( 'wp_nav_menu_args', $this, 'modify_primary_menu' );
	}
