...
class Hestia_Additional_Views extends Hestia_Abstract_Main {
	...
	public function init() {
		$this->loader->add_action( 'hestia_after_single_post_article', $this, 'post_after_article' );

		$this->loader->add_action( 'hestia_blog_social_icons', $this, 'social_icons' );

		$this->loader->add_action( 'wp_footer', $this, 'scroll_to_top' );

		$this->loader->add_action( 'hestia_blog_related_posts', $this, 'related_posts' );
	}
