...
class Hestia_Individual_Single_Layout extends Hestia_Abstract_Main {
	...
	public function init() {
		...
		$this->loader->add_action( 'save_post', $this, 'save_meta_box' );
		$this->loader->add_filter( 'theme_mod_hestia_page_sidebar_layout', $this, 'get_individual_layout' );
		$this->loader->add_filter( 'theme_mod_hestia_blog_sidebar_layout', $this, 'get_individual_layout' );
	}
