...
class Hestia_Header_Layout_Manager extends Hestia_Abstract_Main {
	...
	public function init() {
		...
		$this->loader->add_filter( 'get_the_archive_title', $this, 'filter_archive_title' );

		// Single Post
		$this->loader->add_action( 'hestia_before_single_post_wrapper', $this, 'post_header' );
		$this->loader->add_action( 'hestia_before_single_post_content', $this, 'post_before_content' );

		// Page
		$this->loader->add_action( 'hestia_before_single_page_wrapper', $this, 'page_header' );
		$this->loader->add_action( 'hestia_before_page_content', $this, 'page_before_content' );

		// Index
		$this->loader->add_action( 'hestia_before_index_wrapper', $this, 'generic_header' );
		// Search
		$this->loader->add_action( 'hestia_before_search_wrapper', $this, 'generic_header' );
		// Attachment
		$this->loader->add_action( 'hestia_before_attachment_wrapper', $this, 'generic_header' );
		// Archive
		$this->loader->add_action( 'hestia_before_archive_content', $this, 'generic_header' );

		$this->loader->add_action( 'hestia_before_woocommerce_wrapper', $this, 'generic_header' );
