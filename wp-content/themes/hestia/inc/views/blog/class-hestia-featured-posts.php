...
class Hestia_Featured_Posts extends Hestia_Abstract_Main {
	...
	public function init() {
		$this->loader->add_action( 'hestia_before_index_posts_loop', $this, 'render_featured_posts' );
		$this->loader->add_filter( 'hestia_filter_skipped_posts_in_main_loop', $this, 'remove_featured_posts_in_main_loop', 0 );
	}
