...
class Hestia_Sidebar_Layout_Manager extends Hestia_Abstract_Main {
	...
	public function init() {
		// Single Post
		$this->loader->add_filter( 'hestia_filter_single_post_content_classes', $this, 'post_content_classes' );

		// Page
		$this->loader->add_filter( 'hestia_filter_page_content_classes', $this, 'page_content_classes' );
		$this->loader->add_action( 'hestia_page_sidebar', $this, 'render_page_sidebar' );

		// Index and search
		$this->loader->add_filter( 'hestia_filter_index_search_content_classes', $this, 'index_search_content_classes' );

		// Archive
		$this->loader->add_filter( 'hestia_filter_archive_content_classes', $this, 'archive_content_classes' );

		// Blog Sidebar
		$this->loader->add_filter( 'hestia_filter_blog_sidebar_classes', $this, 'blog_sidebar_classes' );

		// Shop Sidebar.
		$this->loader->add_filter( 'hestia_filter_woocommerce_content_classes', $this, 'content_classes' );
	}
