...
class Hestia_Elementor_Compatibility extends Hestia_Abstract_Main {
	...
	public function init() {
		$this->loader->add_action( 'after_switch_theme', $this, 'set_elementor_flag' );

		if ( ! $this->should_load_feature() ) {
			return;
		}

		$this->loader->add_action( 'elementor/frontend/after_enqueue_styles', $this, 'enqueue_elementor_styles' );
		$this->loader->add_action( 'wp_enqueue_scripts', $this, 'page_builder_enqueue' );

		$this->loader->add_action( 'wp_ajax_hestia_pagebuilder_hide_frontpage_section', $this, 'hestia_pagebuilder_hide_frontpage_section' );
		$this->loader->add_action( 'wp_ajax_hestia_elementor_deactivate_default_styles', $this, 'hestia_elementor_deactivate_default_styles' );
