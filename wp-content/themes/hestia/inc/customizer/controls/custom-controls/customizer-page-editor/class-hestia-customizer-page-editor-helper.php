...
class Hestia_Customizer_Page_Editor_Helper extends Hestia_Abstract_Main {
	...
	public function init() {
		$this->loader->add_action( 'customize_controls_print_footer_scripts', $this, 'customize_editor', 1 );
		$this->loader->add_action( 'save_post', $this, 'trigger_sync_from_page', 10 );
		$this->loader->add_action( 'customize_save', $this, 'trigger_sync_from_customizer', 10 );
		$this->loader->add_action( 'after_setup_theme', $this, 'sync_controls' );
		$this->loader->add_action( 'wp_ajax_hestiaUpdateFrontPageChange', $this, 'update_frontpage_change' );

		$this->loader->add_filter( 'tiny_mce_before_init', $this, 'override_tinymce_options' );
		$this->loader->add_filter( 'wp_default_editor', $this, 'change_editor_mode_to_html' );
		$this->filter_content();
	}
