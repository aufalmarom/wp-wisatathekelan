...
class Hestia_General_Controls extends Hestia_Register_Customizer_Controls {
	...
	public function init() {
		parent::init();
		if ( is_rtl() ) {
			$this->loader->add_filter( 'hestia_layout_control_image_left', $this, 'rtl_layout_control_right_image' );
			$this->loader->add_filter( 'hestia_layout_control_image_right', $this, 'rtl_layout_control_left_image' );
		}
	}
